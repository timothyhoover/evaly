...
const MainSection = () => (
	<div className="main-section">
		<div className="main-section__row-1">
			<img src={img1} className="main-section__img-1" alt="" />
		...
		<div className="main-section__row-2">
			...
			<img src={img2} className="main-section__img-2" alt="" />
		</div>
		<div className="main-section__row-3">
			<img src={img3} className="main-section__img-3" alt="" />
			<div className="main-section__text">
		...
		<div className="main-section__row-4">
			...
			<img src={img4} className="main-section__img-4" alt="" />
		</div>
	</div>
);
